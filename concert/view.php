        ...
        <div class="sub_menu">
            <div class="sub_inner">
                ...
                <ul>
                    ...
                    <li class="current"><a href="list.php">관람후기</a></li>
                    <li><a href="sub6_3.html">자주묻는 질문</a></li>
        ...
        <article id="content">
            <div class="title_area">
                <div class="title_inner">
                    <div class="line_map">
                        <span class="hidden">home</span><i class="fas fa-home"></i> &gt; 열린광장 &gt; <strong>관람후기</strong>
                    </div>
                    <h2>관람후기</h2>
                </div>
            </div>
                    ...
                    <div class="img_box">
                        ...
                        for ($i=0; $i<3; $i++)  //업로드된 이미지를 출력한다
                        {
                            if ($image_copied[$i])
                            {
                                ...
                                echo "<img src='$img_name' width='$img_width' alt='후기 이미지'>"."<br><br>";
                            }
                        }
                        ?>
