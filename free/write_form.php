        ...
        <article id="content">
            ...
            <div class="content_area">
                ...
                <? 	if ($mode=="modify" && $item_file_0)
                    {
                ?>
                            <div class="delete_ok file1"><?=$item_file_0?> 파일이 등록되어 있습니다. <input type="checkbox" name="del_file[]" value="0"> 삭제</div>
                            <div class="clear"></div>
                <?
                    }
                ?>
                ...
                <? 	if ($mode=="modify" && $item_file_1)
                    {
                ?>
                            <div class="delete_ok file2"><?=$item_file_1?> 파일이 등록되어 있습니다. <input type="checkbox" name="del_file[]" value="1"> 삭제</div>
                            <div class="clear"></div>
                <?
                    }
                ?>
                ...
                <? 	if ($mode=="modify" && $item_file_2)
                    {
                ?>
                            <div class="delete_ok file3"><?=$item_file_2?> 파일이 등록되어 있습니다. <input type="checkbox" name="del_file[]" value="2"> 삭제</div>
                            <div class="clear"></div>
                <?
                    }
                ?>
