...
<?
  ...
  암호화된 pass가 입력된 pass의 암호화와 일치하는가를 확인해야함*/
        ...
        function generateRandomPassword($length=8, $strength=0) {
            $vowels = 'aeuy';
            $consonants = 'acegikmoqsuwy';
            if ($strength & 1) {
                $consonants .= 'BDFHJLNPRTVXZ!@#';
            }
        ...
        echo "<strong>$username 님의 [ 임시 비밀번호 ]</strong><br>
           임시 비밀번호는 <strong class='new_pw'> $ranpass </strong> 입니다. 로그인 후 비밀번호를 변경해 주세요.";
